...
RootDirEntries		dw ROOT_ENTRIES	    	; Number of entries in root dir
				                            ; (224 * 32 = 7168 = 14 sectors to read)
LogicalSectors		dw SECTORS	              	; Number of logical sectors
MediumByte		    db 0F0h	                	; Medium descriptor byte
SectorsPerFat		dw SECT_PER_FAT            	; Sectors per FAT
SectorsPerTrack		dw SECT_PER_TRACK          	; Sectors per track (36/cylinder)
...
VolumeLabel	    	db "BOOTFS     "            ; Volume Label: any 11 chars
